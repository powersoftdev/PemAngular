...
@Component({
  selector: 'app-absentee-summary-reports',
  templateUrl: './absentee-summary-reports.component.html',
  styleUrls: ['./absentee-summary-reports.component.css']
})
export class AbsenteeSummaryReportsComponent implements OnInit {
